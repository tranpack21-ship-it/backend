...
export const PRESUPUESTOS_MENU_PERMISSIONS = [
  PERMISSION_CODES.PRESUPUESTOS_VER,
  PERMISSION_CODES.PRESUPUESTOS_CREAR,
  PERMISSION_CODES.PRESUPUESTOS_ANULAR,
  PERMISSION_CODES.PRESUPUESTOS_CONVERTIR,
];
